...
<head>
    ...
    <link rel="stylesheet" href="../../src/css/admin/test_management.css">
</head>
                    ...
                    <table>
                        ...
                        <?php while ($test = $tests->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="../../controllers/TestmanController.php" class="inline"
                                        onsubmit="return confirm('Xác nhận xóa đề thi này?');">
